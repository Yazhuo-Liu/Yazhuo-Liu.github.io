...
The installation package of ifort version 2024.2 can be downloaded [here](https://github.com/Yazhuo-Liu/install-abaqus-on-ubuntu/blob/main/l_fortran-compiler_p_2024.2.1.80.sh)
